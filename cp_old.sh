...
for dataset in {"gs://gresearch/robotics/droid/",\
"gs://gresearch/robotics/droid_100/",\
"gs://gresearch/robotics/droid_raw/",\
"gs://gresearch/robotics/eth_agent_affordances/",\
"gs://gresearch/robotics/fanuc_manipulation_v2/",\
...
"gs://gresearch/robotics/viola/"}
 do
  ...
  gsutil -m cp -r "$dataset*" gs://mbodi/datasets/oxe
done
