...
from oxe_torch.rt1.film_efficientnet import film_efficientnet_encoder, pretrained_efficientnet_encoder
import unittest
import numpy as np
...
class PretrainedEfficientnetEncoderTest(unittest.TestCase):
    def test_encoding(self):
        ...
        model = pretrained_efficientnet_encoder.EfficientNetEncoder(token_embedding_size = token_embedding_size)
        model.eval()
    ...
    def test_imagenet_classification(self):
        ...
        # prediction
        model = pretrained_efficientnet_encoder.EfficientNetEncoder(include_top=True)
        model.eval()
